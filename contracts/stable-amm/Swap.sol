...
contract Swap is OwnerPausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // swapFromBase(address pool, address basePool, uint8 tokenIndexFrom, uint8 tokenIndexTo, uint256 dx, uint256 minDy, uint256 deadline)Index function also relies on this mapping to retrieve token index.
