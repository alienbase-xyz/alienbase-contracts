...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    //@notice Keep stock Uniswap. Chads don't pretend they didn't just fork something
    //And it helps MEV chads with flash loan signatures
    ...
    //@notice denominator mul(1) == 50% protocol share.
    //most LP income will come from token emissions (see Curve)
